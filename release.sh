...
git push "https://$username:$password@github.com/carlosthe19916/xavier-integration.git"

# Create tag and push
git tag "$releaseVersion"
git push "https://$username:$password@github.com/carlosthe19916/xavier-integration.git" --tags
